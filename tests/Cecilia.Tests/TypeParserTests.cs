...
namespace Cecilia.Tests
{
    ...
    public class TypeParserTests : BaseTestFixture
    {
        ...
        public void SimpleTypeDefinition()
        {
            ...
            const string fullname = "Cecilia.Tests.TypeParserTests";

            var type = TypeParser.ParseType(module, fullname);
            Assert.IsNotNull(type);
            Assert.AreEqual(module, type.Scope);
            Assert.AreEqual(module, type.Module);
            Assert.AreEqual("Cecilia.Tests", type.Namespace);
        ...
        public void FullyQualifiedTypeReference()
        {
            ...
            var fullname = "Cecilia.TypeDefinition, " + cecil.FullName;

            var type = TypeParser.ParseType(module, fullname);
            Assert.IsNotNull(type);
            Assert.AreEqual(cecil, type.Scope);
            Assert.AreEqual(module, type.Module);
            Assert.AreEqual("Cecilia", type.Namespace);
        ...
        public void SimpleNestedType()
        {
            ...
            const string fullname = "Cecilia.Tests.TypeParserTests+ID";
            ...
            Assert.AreEqual("Cecilia.Tests.TypeParserTests/ID", type.FullName);
        ...
        public void GenericInstanceMixedArguments()
        {
            ...
            var fullname = string.Format("System.Collections.Generic.Dictionary`2[Cecilia.Tests.TypeParserTests,[System.String, {0}]]",
                typeof(object).Assembly.FullName);
            ...
            Assert.AreEqual(module, argument.Module);
            Assert.AreEqual("Cecilia.Tests", argument.Namespace);
        ...
        public void GenericInstanceTwoNonFqArguments()
        {
            ...
            var fullname = string.Format("System.Collections.Generic.Dictionary`2[Cecilia.Tests.TypeParserTests+Bar,Cecilia.Tests.TypeParserTests+Bar], {0}", typeof(object).Assembly.FullName);
        ...
        public void ComplexGenericInstanceMixedArguments()
        {
            ...
            var fullname = string.Format("System.Collections.Generic.Dictionary`2[[System.String, {0}],Cecilia.Tests.TypeParserTests+Foo`2[Cecilia.Tests.TypeParserTests,[System.Int32, {0}]]]",
                typeof(object).Assembly.FullName);
            ...
            Assert.AreEqual("Cecilia.Tests.TypeParserTests/Foo`2", instance.ElementType.FullName);
